...
void UK2Node_LowEntry_CreateJsonObject::AllocateDefaultPins()
{
	...
	UEdGraphPin* ObjectOutputPin = CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Object, TEXT(""), ULowEntryJsonObject::StaticClass(), false, false, TEXT("JsonObject"));
	UEdGraphPin* ArrayOutputPin = CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Object, TEXT(""), ULowEntryJsonObjectEntry::StaticClass(), true, false, TEXT("TempArray"));
	...
	{
		CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Object, TEXT(""), ULowEntryJsonObjectEntry::StaticClass(), false, false, *FString::Printf(TEXT("[%d]"), i));
	}
}
